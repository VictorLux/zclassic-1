...
| 🔒 | **B8** | B8 — delete the comparison apparatus (~9,448 LOC) in the mandatory sequence 🔒owner | n/a (irreversible removal of the safety net; post-soak only) | F2 |
