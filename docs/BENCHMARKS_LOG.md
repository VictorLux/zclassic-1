...
| 2026-05-24 21:40 | e4b5528ea | #3 RSS (plateau) | **~1.93 GB stable** | soak CSV: uptime 329s=1927MB, 389/449/510s all 1927, 570s=1951. **Plateaus ~1.93 GB after bg-verify warm-up — bounded, NOT a leak.** Earlier "2.0 GB regression" was warm-up + measurement timing, not unbounded growth. Floor still ~2× the 1 GB target → Phase-3 monolith dissolve is the lever (they hold the buffers). |
