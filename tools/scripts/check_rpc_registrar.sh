#!/usr/bin/env bash
# Wave 9a lint gate: every register_*_rpc_commands() callsite must use
...
# programmer error — duplicate name, MAX_RPC_COMMANDS cap hit, or table
# already running. Silent drops left the control-group RPCs unreachable
# for a full release cycle until wave 9a; this gate prevents regressions.
#
