...
const char *ScriptErrorString(ScriptError serror)
{
    ...
    case SCRIPT_ERR_CHECKDATASIGVERIFY: return "Script failed an OP_CHECKDATASIGVERIFY operation";
    ...
    case SCRIPT_ERR_SIG_PUSHONLY: return "Only non-push operators allowed in signatures";
    ...
    case SCRIPT_ERR_DISCOURAGE_UPGRADABLE_NOPS: return "NOPx reserved for soft-fork upgrades";
