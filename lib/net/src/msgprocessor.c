...
static bool process_sendcmpct(struct p2p_node *node, struct byte_stream *s)
{
...
static bool process_cmpctblock(struct msg_processor *mp, struct p2p_node *node,
                               struct byte_stream *s)
{
    struct compact_block_msg cb;
...
static bool process_getblocktxn(struct msg_processor *mp, struct p2p_node *node,
                                struct byte_stream *s)
{
    struct block_txn_request req;
...
static bool process_blocktxn(struct msg_processor *mp, struct p2p_node *node,
                             struct byte_stream *s)
{
    (void)mp;
    struct block_txn_response resp;
