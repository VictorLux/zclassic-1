 ...
 *      Sprout regime (returns false). The ZIP-243 Sapling regime does
 *      NOT reject it — it commits to a NULL outputs digest and succeeds.
 *      That asymmetry is consensus-load-bearing and must be pinned on
 *      both sides, including the nasty num_vout==0 boundary.
