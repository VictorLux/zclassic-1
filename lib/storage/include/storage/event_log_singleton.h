 ...
 * event_log_t used by Phase 4 projections and shadow emitters.
 *
 * The event_log primitive itself (lib/storage/src/event_log.c) is
 * a deliberately stateless library — it owns no global handle. Phase 4
 * projections, however, need a way to find the one-and-only log
