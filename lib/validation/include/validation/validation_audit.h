 ...
 * ===================================
 *
 * This file documents EXACTLY what cryptographic validation is performed
 * at each stage of block processing. "Trust nothing" — every hash, every
 * signature, every proof is verified by one of these layers.
 *
 * ============================================================================
 ...
 *
 * ── SYNC METHODS (see SYNC.md for operator guide) ─────────────────────
 *
...
#ifndef ZCL_VALIDATION_AUDIT_H
#define ZCL_VALIDATION_AUDIT_H
/* This is a documentation-only header. No code. */
#endif
