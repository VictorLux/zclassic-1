...
const char *event_type_name(enum event_type type)
{
    static const char *names[] = {
        ...
        [EV_BLOCK_RECEIVED]          = "sync.block_received",
        [EV_BLOCK_DESERIALIZED]      = "val.block_deserialized",
        [EV_BLOCK_HEADER_CHECKED]    = "val.header_checked",
        [EV_BLOCK_SCRIPTS_VERIFIED]  = "val.scripts_verified",
        [EV_BLOCK_CONNECTED]         = "val.block_connected",
        [EV_BLOCK_REJECTED]          = "val.block_rejected",
        [EV_BLOCK_PERSISTED]         = "val.block_persisted",
        [EV_TIP_UPDATED]             = "chain.tip_updated",
        [EV_REORG_START]             = "chain.reorg_start",
        [EV_REORG_COMPLETE]          = "chain.reorg_complete",
        [EV_COINS_FLUSH]             = "chain.coins_flush",
        [EV_COINS_FLUSH_FAILED]      = "chain.coins_flush_fail",
        [EV_TX_RECEIVED]             = "tx.received",
        ...
        [EV_SNAPSHOT_CHUNK_RECEIVED] = "snap.chunk_received",
