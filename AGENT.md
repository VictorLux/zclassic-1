...
|---|---|---|
| **CRITICAL** | 27 / 34 | **P24.18** (connect_tip silent-fail + Sapling end-height), **P24.19** (clean-shutdown + fast-boot, eliminates 13-min rebuild cycle), **P24.24** (transactional chain advance — atomic block-commit) |
| **HIGH** | 35 / 62 | P12.3, P12.3.1, P13.2, P13.4, P13.6, P13.7, P14.4, P14.5, P14.15, P14.16, P15.1, P15.2, P15.4, P15.6, P16.1, P16.2, P17.1, P17.2, P17.4, P17.5, P17.6, P18.1, P19.1, P24.2, P24.3, P24.4, P24.5, P24.7, P24.8, P24.10, **P24.15**, **P11.8**, **P24.20** (error propagation), **P24.21** (anchor roll-forward), **P24.22** (boot invariant check), **P24.23** (validated state snapshots) |
...
- **Agent-2 NOW: P24.18** (connect_tip silent-fail — THE stall fix). **Wave now 7 rows deep** (was 5). Extended +3 rows at 02:00 to cover the full "STICKY STRONG ROBUST" matrix:
  - **P24.18** CRIT (NOW) → P24.19 CRIT → P24.20 HIGH → P24.21 HIGH → **P24.22 HIGH** (boot invariant check) → **P24.23 HIGH** (validated state snapshots, eliminates Sapling rebuild) → **P24.24 CRIT** (transactional chain advance — atomic block-commit).
  - **Why extended:** P24.18-P24.21 fix the current cascade. P24.22-P24.24 prevent the class from recurring (boot-invariant catches silent divergence; snapshots make boot fast; transactional advance makes partial-advance corruption structurally impossible).
  - **Expected KPI lift:** ~55 → ~82 points (more than half the gap to 100). Full breakdown in AGENT-2.md Mandate section.
