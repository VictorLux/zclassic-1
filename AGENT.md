...
- **Agent-2 (2 logical tasks + 5 P8 rows):** P8.1 (CRIT zmsg_deserialize overflow, NOW), then P7.9+P7.10, then P8.4/P8.5/P8.6/P8.7/P8.8. (P4.1+P4.2 landed `a9fcf6c66`; P8.9 HOTFIX landed `b875152da` — awaiting deploy canary.)
