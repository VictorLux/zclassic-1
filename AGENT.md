...
**Overall: 72 / 106 rows closed (68%) | SWRC ~74%** (P12.1 sapling tree checkpoint closed in wave 8fb7cb623; denominator +6 for P14.1–P14.6; P10.1.5 row de-closed since earlier "done" was wrong)

| Tier | Closed / Total | % | Open rows |
|---|---|---|---|
| **CRITICAL** | 13 / 20 | **65%** | P8.10 (SUPERSEDED), P9.2 (deferred), **P14.1** (savepoint flush — Agent-2 NOW — real P10.1 root cause), **P14.2** (true P10.1.3 end-to-end RED — Agent-2), **P14.3** (`zcl_syncdiag` SIGABRT — Agent-2), **P14.6** (BLOCK_FAILED_CHILD GC — promoted from HIGH/P12.2 — Agent-2), P12.1 ✅ done 8fb7cb623 (sapling checkpoint — Agent-3), **P13.1** (single-peer sync — DEFERRED behind P14) |
