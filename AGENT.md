...
**Overall: 74 / 106 rows closed (70%) | SWRC ~75%** (P12.1 sapling checkpoint closed in 8fb7cb623; P14.1 + P14.2 landed in 2b9b9f4d3 as coupled RED→GREEN commit; P10.1.5 row still de-closed pending the canary Rhett re-runs after P14.1 deploys)
